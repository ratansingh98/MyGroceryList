package com.example.ratan.mygrocerylist.Data;
...
import com.example.ratan.mygrocerylist.Util.Constants;
...
public class DatabaseHandler extends SQLiteOpenHelper {
    ...
    public Grocery getGrocery(int id) {
        ...
        Cursor cursor = db.query(Constants.TABLE_NAME,
                new String[]{Constants.KEY_ID, Constants.KEY_GROCERY_ITEM, Constants.KEY_QUANTITY_NUMBER, Constants.KEY_DATE_NAME},
                Constants.KEY_ID + "=?",
